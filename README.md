...
[![Views](https://img.shields.io/badge/dynamic/json?color=blue&label=views&query=$.views&url=https://api.countapi.xyz/hit/nicanorflavier/readme)](https://github.com/nicanorflavier/ssl-certificate-chain-guide)
